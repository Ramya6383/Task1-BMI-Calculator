...
image_icon=PhotoImage(file="C:\\Users\\AJAYKUMAR\\OneDrive\\Desktop\\intern\\icon.gif")
root.iconphoto (False, image_icon)

top=PhotoImage(file="C:\\Users\\AJAYKUMAR\\OneDrive\\Desktop\\intern\\top.gif")
top_image=Label(root,image=top,background="grey")
top_image.place(x=-10,y=-10)

Label(root,width=72,height=18,bg="lightblue").pack(side=BOTTOM)

box=PhotoImage(file="C:\\Users\\AJAYKUMAR\\OneDrive\\Desktop\\intern\\box.gif")
Label(root,image=box).place(x=20,y=100)
Label(root,image=box).place(x=240,y=100)

scale=PhotoImage(file="C:\\Users\\AJAYKUMAR\\OneDrive\\Desktop\\intern\\scale.gif")
...
def slider_changed(event):
    ...
    img=(Image.open("C:\\Users\\AJAYKUMAR\\OneDrive\\Desktop\\intern\\man.gif"))
...
Button(root,text="Result",width=15,height=2,font="arial 10 bold",bg="darkblue",fg="white",command=BMI).place(x=280,y=340)
label1=Label(root,font="arial 60 bold",bg="lightblue",fg="white")
label1.place(x=125,y=305)
label2=Label(root,font="arial 20 bold",bg="lightblue",fg="red")
